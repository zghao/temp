 ...
 */
public class LeftMycollectionActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.left_mycollection);
        initView();
    }
    private void initView() {
        btBack= (Button) findViewById(R.id.left_mycollection_btback);
        btCorp= (Button) findViewById(R.id.left_mycollection_btcorp);
        btPerson= (Button) findViewById(R.id.left_mycollection_btperson);
    ...
    private void setFragment(Fragment fragment) {
        ...
        fragmentTransaction.replace(R.id.left_mycollection_fl, fragment);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.left_mycollection_btback:
                finish();
                break;
            case R.id.left_mycollection_btcorp:
                if(!Flag_Button){
                ...
                break;
            case R.id.left_mycollection_btperson:
                if(Flag_Button){
