...
/**
 * Created by hhzggg on 2015/7/9.
 */
public class PersonshowFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.person_show,container,false);
        initView();
        return view;
    }

    private void initView() {
        btOpen= (Button) view.findViewById(R.id.person_show_btopen);
        btNew= (Button) view.findViewById(R.id.person_show_btnew);
        btHot= (Button) view.findViewById(R.id.person_show_bthot);
        btOpen.setOnClickListener(this);
        btNew.setOnClickListener(this);
        btHot.setOnClickListener(this);
        PersonshowHotFragment fragment=new PersonshowHotFragment();
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.person_show_btopen:
                MainActivity mainActivity= (MainActivity) getActivity();
                mainActivity.OpenDrawer();
                break;
            case R.id.person_show_bthot:
                if(!flag_button){
            ...
            case R.id.person_show_btnew:
                if(flag_button){
                    ...
                    PersonshowNewFragment fragment=new PersonshowNewFragment();
                    setFragment(fragment);
                    flag_button=false;
                }
                break;
    ...
    private void setFragment(Fragment fragment) {
        ...
        fragmentTransaction.replace(R.id.person_show_fl, fragment);
